...
namespace PhpPp\Core\Component\Tests\Unit\Exception\KeyNotFoundException;

use PhpPp\Collection\Component\{
    Exception\KeyNotFoundException,
    Tests\Unit\TestToString
};
use PHPUnit\Framework\TestCase;

/** @covers \PhpPp\Collection\Component\Exception\KeyNotFoundException::__construct */
