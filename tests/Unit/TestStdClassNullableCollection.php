...
use PhpPp\Collection\Contract\Collection\NullableInterface;

class TestStdClassNullableCollection extends AbstractObjectCollection implements NullableInterface
{
